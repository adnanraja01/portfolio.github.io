      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 gap-[50rem] md:gap-[65rem] lg:gap-24 lg:grid-cols-2">
          ...
          <div className="col-span-1 px-[2rem]">
            <div className="flex">
              <h4 className=" text-s40 lg:text-s48 font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#0062ff]  to-[#61efff] ">
                About Me
              </h4>
            </div>

            <p className="text-grey text-s18 lg:text-s22">
            ...
            <p className="pt-[3rem] text-grey text-s18 lg:text-s22">
            ...
            <div className="mt-[4rem]">
              <p className="text-s18 lg:text-s20 text-grey font-semibold ">
